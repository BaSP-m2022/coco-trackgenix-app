...
const Table = ({ data, headers, children, handleEdit, deleteItem }) => {
  ...
  // ACA MODIFICO LA DATA SI ES EMPLOYEE O PM
  // if (pm ? employee) {data.project (mostrar solo los proyectos q esta employee)}
  // Ver botones necesita employee
  // const dataModificada = data.filter((project) => project.employee._id )
  return (
