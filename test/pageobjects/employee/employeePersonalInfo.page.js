class employeePersonalInfoPage {
  ...
  get containerTable() {
    return $('#root > div > div > section > div.table_container__2zHgd > table > tbody');
  }
  get titleCard() {
    return $('//*[@id="root"]/div/div/section/h2[2]');
  }
  ...
  async editElementGetPath(elementNr) {
    ...
    const secondHalf = ']/td[7]/button[1]';
  ...
  async deleteElementGetPath(elementNr) {
    const firstHalf = '//*[@id="root"]/div/div/section/div[2]/table/tbody/tr[';
    const secondHalf = ']/td[7]/button[2]';
    const res = await firstHalf.concat(elementNr, secondHalf);
    return res;
  }
